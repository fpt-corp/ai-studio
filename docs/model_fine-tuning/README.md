...
**Note:**
- To start a fine-tuning job, you must maintain a minimum balance = number of nodes × number of GPUs × cost per block.  
- If your balance falls below 0, the fine-tuning job will be canceled.  
  After topping up, you will need to restart the job from the beginning.
...
- Follow the detailed guide here:  
  [https://fptcloud.com/en/documents/model-fine-tuning/?doc=create-pipeline](https://fptcloud.com/en/documents/model-fine-tuning/?doc=create-pipeline)
...
* Follow the detailed guide here:  
[https://fptcloud.com/en/documents/model-fine-tuning/?doc=manage-pipeline](https://fptcloud.com/en/documents/model-fine-tuning/?doc=manage-pipeline)
...
* Follow the detailed guide here:  
[https://fptcloud.com/en/documents/model-fine-tuning/?doc=monitor-and-evaluate](https://fptcloud.com/en/documents/model-fine-tuning/?doc=monitor-and-evaluate)
